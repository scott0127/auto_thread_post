...
class ThreadsAPI:
    ...
    def __init__(
        ...
        print(f"ACCESS_TOKEN: {self.access_token[:10]}...")  # 部分隱藏以保護敏感資訊
        print(f"APP_SECRET: {self.app_secret[:10]}...")  # 部分隱藏以保護敏感資訊
...
if __name__ == "__main__":
    ...
    # 呼叫 get_long_live_access_token 方法
    try:
        response = threads_api.get_long_live_access_token()
        print("Long-lived access token response:")
        print(response)
